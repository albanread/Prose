...
cmake()
{
	...
	--build|--install|-E|-P|--open|--version|--help)
		...
		;;
	*)
		# CMake 4 refuses projects that ask for < 3.5 (json-c); this lets
		# them configure as they would with the CMake Haiku ships
...
proseDumpRecipe()
{
	...
	for key in PATCH BUILD INSTALL TEST HOST_BUILD; do
